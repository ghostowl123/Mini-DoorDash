...
public class CustomerService {
    ...
    // in this project, I used session-based authentication session stored in memory that may get lost while discharging
    // 有多个server的情况下 我们有可能涉及session storage consistency的问题 即一个server未及时同步登录信息
    @Transactional
    public void signUp(String email, String password, String firstName, String lastName) {
        email = email.toLowerCase();
        //builder pattern 替代了 new 构造函数 --> builder()
        //为什么用这个？ 可以忽视顺序 parameter过多时用
